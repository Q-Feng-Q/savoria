...
- [x] **Step 1: Write the failing happy-path service test**
...
- [x] **Step 3: Write failing validation and fallback tests**
...
- [x] **Step 4: Implement the minimal service method**
...
- [x] **Step 5: Run the focused service test and verify GREEN**
...
- [x] **Step 1: Write the failing controller/API contract test**
...
- [x] **Step 3: Implement springdoc-compliant endpoint and response metadata**
...
- [x] **Step 4: Run dish controller and service tests**
...
- [x] **Step 1: Write failing API and visibility tests**
...
- [x] **Step 3: Implement API and page action**
...
- [x] **Step 4: Run focused and full mini-program tests**
...
- [x] **Step 1: Write failing API contract and source-marker tests**
...
- [x] **Step 2: Run focused PC tests and verify RED**

Run: `node --test admin-web/tests/dish-template-change-requests.test.js`

- [x] **Step 3: Implement table/editor actions**
...
- [x] **Step 4: Run PC tests and production build**
...
- [x] **Step 1: Document the endpoint and response metadata**
...
- [x] **Step 3: Run both frontend regressions and PC build**
...
- [x] **Step 4: Verify UTF-8 and diff hygiene**
...
Verification evidence (2026-08-15): backend `128` tests, `0` failures, `0` errors, `1` skipped because Docker/Testcontainers is unavailable; mini-program `280/280` passed; PC `46/46` passed; Vite production build passed; strict UTF-8 scan found `0` invalid files; `git diff --check` exited successfully.
